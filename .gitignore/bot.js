...
if (message.content === '$help') {
              var embed  = new Discord.RichEmbed()
                .addField("**LINKS**" ,":no_entry_sign: لايسمح بنشر الانفنيات في هذا السيرفر :no_entry_sign: ")
...
client.login("NDE5MTMyNDExMTA0NzIyOTU0.DXrrGw._GAefYvPg_ibwwcamPx0kKLLKu0");
